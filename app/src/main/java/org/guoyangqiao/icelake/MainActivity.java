...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String CHANNEL_ICELAKE = "org.guoyangqiao.icelake";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createChannels();
        notification = new Notification.Builder(getApplicationContext(), CHANNEL_ICELAKE)
...
//        locationOption.setOpenAutoNotifyMode(3000, 10, LocationClientOption.LOC_SENSITIVITY_LOW);
    ...
    public void createChannels() {
        ...
        NotificationChannel androidChannel = new NotificationChannel(CHANNEL_ICELAKE, "ANDROID CHANNEL", NotificationManager.IMPORTANCE_DEFAULT);
